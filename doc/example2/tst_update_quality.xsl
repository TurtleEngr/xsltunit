...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exsl="http://exslt.org/common" xmlns:xsltu="http://xsltunit.org/0/" xmlns:xalan="http://xml.apache.org/xalan" version="1.0" extension-element-prefixes="exsl" exclude-result-prefixes="exsl">
